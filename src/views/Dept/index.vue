<template>
  <div>
    ...
    <el-button type="danger" size="mini" @click="delect" v-if="checkedDeptId">删除</el-button>
    <el-row :gutter="20">
      <el-col :span="8">
        <Dept
      ...
      <el-col :span="16">
        <el-form ref="editform" :model="editform" label-width="80px" :rules="rules">
          <el-form-item label="部门名称" prop="name">
            <el-input v-model="editform.name" style="max-width: 200px "></el-input>
          </el-form-item>
    ...
    <el-dialog title="提示" :visible.sync="showFrom">
...
export default {
  ...
  methods: {
    ...
    // 删除部门
    delect(){
      console.log('请调用删除部门接口')
      this.checkedDeptId=0
      this.getDept()
    }
  },
  watch: {
